    ...
    sponsors: [
      {
        ...
        subtitleHindi: 'आधिकारिक प्रधान प्रायोजक ',
    ...
    sponsors: [
      {
        ...
        subtitleHindi: 'आधिकारिक सह-प्रस्तुतकर्ता A',
        status: 'To be Updated',
      },
      {
        id: 'p3',
        ...
        subtitleHindi: 'आधिकारिक सह-प्रस्तुतकर्ता B',
        status: 'To be Updated',
      },
    ],
  },
  {
    titleHindi: 'सह-प्रायोजक',
    ...
    sponsors: [
      {
        ...
        subtitleHindi: 'सांस्कृतिक संस्थान सहयोगी',
        status: 'To be Updated',
      },
      {
        id: 'p5',
        ...
        subtitleHindi: 'आतिथ्य एवं स्थल सहयोगी',
        status: 'To be Updated',
      },
      {
        id: 'p6',
        ...
        subtitleHindi: 'डिजिटल प्लेटफॉर्म सहयोगी',
        status: 'To be Updated',
      },
    ],
  },
  {
    titleHindi: 'मीडिया एवं प्रचार',
    ...
    sponsors: [
      {
        ...
        subtitleHindi: 'आधिकारिक प्रिंट मीडिया सहयोगी',
        status: 'To be Updated',
      },
      {
        id: 'p8',
        ...
        subtitleHindi: 'आधिकारिक रेडियो सहयोगी',
        status: 'To be Updated',
      },
    ],
  },
